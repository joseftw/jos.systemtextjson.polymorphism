...
using JOS.SystemTextJsonPolymorphism.Deserialization.PolymorphicCovariant.Car;
using JOS.SystemTextJsonPolymorphism.Deserialization.PolymorphicCovariant.Truck;
using Shouldly;
using Xunit;
